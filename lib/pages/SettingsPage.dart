import 'package:BukuKasKu/helper/dbhelper.dart';
import 'package:BukuKasKu/models/user.dart';
...
class _SettingsPageState extends State<SettingsPage> {
  ...
  String developerName = "Muslimatul Rizki Aulia";
  String developerNim = "2141764076";
  String dateApp = "1 Oktober 2023";
              ...
              children: [
                const CircleAvatar(
                  backgroundImage: AssetImage(
                      'assets/images/foto.jpeg'), // Gantilah dengan path gambar Anda
                  radius: 50,
                ),
                Container(
